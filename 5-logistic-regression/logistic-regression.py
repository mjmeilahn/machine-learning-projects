...
# print(regressor.predict(scaler.transform([[30, 87000]])))
...
# plt.contour(x1, x2, regressor.predict(scaler.transform(np.array([x1.ravel(), x2.ravel()]).T)).reshape(x1.shape), alpha = 0.75, cmap = ListedColormap(('red', 'green')))
